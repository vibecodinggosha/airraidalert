...
ДРОНИ:
- Ройовий формат: сотні дронів за ніч, окремі атаки 500+ БПЛА
- Між великими ударами — менші щоденні хвилі для виснаження
- Мета: виснаження ППО + психологічний тиск + навантаження на енергетику
- Квітень 2025: більше БПЛА ніж у березні, зміна від хаотичних до концентрованих атак
- Травень 2025 прогноз: спад БПЛА але зростання ракетного озброєння

РАКЕТИ:
- З 7 масованих обстрілів квітня лише 3 були ракетними — ракетна компонента слабка
- Більше немає виключно балістично-дронових атак — усі масовані або чисто дронові, або мішані (балістичні + крилаті)
- Ракети морського базування використовуються в кожній 2-3 атаці

ЦІЛІ:
- Акцент на ОПК (оборонно-промисловий комплекс)
- Точкові енергетичні удари: малі підстанції, локальні розподільчі вузли (дешевше, складніше відновити)
- Залізничні вузли, порти, паливо, склади
- Одеса, Кременчук, Дніпро, Харків, західні маршрути
- Попередження розвідки про можливі атаки по водопостачанню

ГЕОГРАФІЯ:
- Розширилась на захід, удари ближче до кордонів НАТО
- Маршрути через Білорусь або поблизу Молдови
- Довший час тривог по всій країні
